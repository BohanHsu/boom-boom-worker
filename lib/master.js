...
class WorkerMaster {
  ...
  syncWithControlTower() {
    ...
    console.log('WorkerMaster sync with control tower, timestamp', currentTimestamp); // const isPlaying = !!(this._shouldPlayOperator && this._shouldPlayOperator.isPlaying());
